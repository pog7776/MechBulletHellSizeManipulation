...
public class HighscoreTable : MonoBehaviour {
    ...
    private void Awake() {
        ...
        if (highscores == null) {
            ...
            AddHighscoreEntry(1600, "CMK");
            AddHighscoreEntry(5621, "JOE");
            AddHighscoreEntry(2721, "DAV");
            AddHighscoreEntry(6853, "CAT");
            AddHighscoreEntry(1424, "MAX");
    ...
    public void setConfirm(bool confirm){
        if(GameObject.FindGameObjectWithTag("TextInput").GetComponent<Text>().text != ""){
